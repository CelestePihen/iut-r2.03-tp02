...
class PionBlanc extends Pion {
	...
	public ArrayList<Position> getDeplacementPossible(Plateau pl) throws ErreurCoordonneesException {
		...
		if (this.getPosition().getY() != 7) { // Si le pion n'est pas arrivé au bout - Est ce vraiment éncessaire ? Car
			...
			if (this.getPosition().getY() == 1 && liste.size() == 1) { // le pion n'a pas encore bougé et qu'il n'y a
